...
namespace First.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<ProductsByRows_Result> ProductsByRows(Nullable<int> pBegin, Nullable<int> pEnd)
        {
            var pBeginParameter = pBegin.HasValue ?
                new ObjectParameter("pBegin", pBegin) :
                new ObjectParameter("pBegin", typeof(int));
    
            var pEndParameter = pEnd.HasValue ?
                new ObjectParameter("pEnd", pEnd) :
                new ObjectParameter("pEnd", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProductsByRows_Result>("ProductsByRows", pBeginParameter, pEndParameter);
        }
        ...
        public virtual int usp_GetAllCustomer()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_GetAllCustomer");
        }
    
        public virtual int usp_GetAllCustomers(Nullable<int> rOW_INDEX, Nullable<int> rOWS_PER_PAGE, string whereClause, string sortExpression)
        {
            var rOW_INDEXParameter = rOW_INDEX.HasValue ?
                new ObjectParameter("ROW_INDEX", rOW_INDEX) :
                new ObjectParameter("ROW_INDEX", typeof(int));
    
            var rOWS_PER_PAGEParameter = rOWS_PER_PAGE.HasValue ?
                new ObjectParameter("ROWS_PER_PAGE", rOWS_PER_PAGE) :
                new ObjectParameter("ROWS_PER_PAGE", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_GetAllCustomers", rOW_INDEXParameter, rOWS_PER_PAGEParameter, whereClauseParameter, sortExpressionParameter);
        }
    
        public virtual int usp_GetAllCustomersCount(string whereClause)
        {
            var whereClauseParameter = whereClause != null ?
                new ObjectParameter("WhereClause", whereClause) :
                new ObjectParameter("WhereClause", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_GetAllCustomersCount", whereClauseParameter);
        }
    
        public virtual int usp_GetCustomerByCompanyName(string whereClause)
        {
            var whereClauseParameter = whereClause != null ?
                new ObjectParameter("WhereClause", whereClause) :
                new ObjectParameter("WhereClause", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_GetCustomerByCompanyName", whereClauseParameter);
        }
    
        public virtual int usp_GetCustomerByID(string customerID)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(string));
